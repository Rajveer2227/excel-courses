    ...
    return (
        <div className="min-h-screen bg-white pb-20">
            ...
            <div className={cn("pt-20 pb-24 relative overflow-hidden bg-gradient-to-br", course.color)}>
                ...
                <div className="mx-auto w-full max-w-4xl px-6 md:px-12 lg:pl-28 relative z-10 text-center">
            ...
            <div className="w-full relative -mt-16 container mx-auto px-6 md:px-12 lg:pl-28 z-10">
            ...
            <div className="w-full max-w-[1600px] mx-auto px-6 mt-12">
                <div className="flex flex-col lg:flex-row items-start justify-center gap-12 lg:gap-20 lg:pl-28">
                    ...
                    <div className="w-full lg:w-[400px] lg:sticky lg:top-24 h-fit shrink-0">
