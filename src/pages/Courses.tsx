...
export default function Courses() {
    ...
    return (
        <div className="min-h-screen bg-[#0d1117] pt-24 pb-32 relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 md:px-12 md:pl-32 lg:pr-12 max-w-7xl relative z-10">
                ...
                <div className="mb-12 flex flex-col lg:flex-row lg:items-end justify-between gap-8">
                    ...
                    <motion.div
                        initial={{ opacity: 0, x: 20 }}
                        animate={{ opacity: 1, x: 0 }}
                        className="relative w-full md:max-w-2xl lg:w-[450px] group"
                    >
                ...
                <motion.div
                    ...
                    className="flex flex-wrap gap-3 md:gap-4 mt-12 mb-16"
                >
