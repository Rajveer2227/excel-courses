...
export default function Home() {
    return (
        <div className="min-h-screen relative bg-[#0d1117] flex flex-col overflow-y-auto overflow-x-hidden">
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-center relative z-10 px-4 md:px-12 lg:pl-28 lg:pr-8 pt-4">
            ...
            <div className="container mx-auto px-6 md:px-12 lg:pl-28 lg:pr-8 relative z-10 pb-10 max-w-5xl shrink-0">
