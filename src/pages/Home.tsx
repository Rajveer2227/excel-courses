...
export default function Home() {
    return (
        <div className="min-h-[100dvh] lg:h-[100dvh] relative bg-[#0d1117] flex flex-col overflow-y-auto lg:overflow-hidden overflow-x-hidden">
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-center relative z-10 px-4 md:px-12 lg:pl-44 lg:pr-8 pt-4">
                ...
                >
                    <h1 className="text-4xl md:text-5xl lg:text-5xl font-black text-white mb-2 md:mb-4 leading-tight flex flex-col items-center">
            ...
            <div className="container mx-auto px-6 md:px-12 lg:pl-44 lg:pr-8 relative z-10 pb-10 max-w-5xl shrink-0">
